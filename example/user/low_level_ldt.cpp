...
void Custom::LowCmdWrite()
{
    ...
    if (motiontime >= 0)
    {
        ...
        if (motiontime >= 400)
        {
            ...
            qDes[0] = sin_mid_q[0];// 侧摆关节
            qDes[1] = sin_mid_q[1] + sin_joint1;//大腿关节
            qDes[2] = sin_mid_q[2] + sin_joint2;//小腿关节
        }
        ...
        /*右前大腿sine*/
        // low_cmd.motor_cmd()[1].q() = qDes[1];
        // low_cmd.motor_cmd()[1].dq() = 0;
        // low_cmd.motor_cmd()[1].kp() = Kp[1];
        // low_cmd.motor_cmd()[1].kd() = Kd[1];
        // low_cmd.motor_cmd()[1].tau() = 0;
